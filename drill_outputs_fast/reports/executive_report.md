...
- Consensus anomalies requiring engineering review: **26**.
...
Best regression model: **Ridge**; temporal holdout MAE **9.59 m/hr**, RMSE **13.14 m/hr**.

Best low-performance classifier: **RandomForest**. Metrics are saved in `models/classification_metadata.json`. Threshold selection uses out-of-fold training probabilities only; the temporal holdout remains untouched until final evaluation.
